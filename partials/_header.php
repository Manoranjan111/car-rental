...
<div class="container-fluid">
  <a class="navbar-brand" href="/rentalcar/index.php">Rental-car</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="/rentalcar/index.php">Home</a>
      </li>
      <li class="nav-item">
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
      ...
      echo'
      <form class="d-flex " action="/rentalcar/partials/_searchResult.php" method ="get" >
        <input class="form-control me-2  " type="search" name="search"  placeholder="Search" aria-label="Search">
        <button class="btn btn-success" type="submit" >Search</button>   
      </form>
